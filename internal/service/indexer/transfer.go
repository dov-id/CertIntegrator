...
func (i *Indexer) handleIssuerTransferLog(eventLog types.Log, client *ethclient.Client) error {
	...
	err = i.handleTransfer(mTree, event, int64(eventLog.BlockNumber))
	if err != nil {
...
func (i *Indexer) handleTransfer(mTree *merkletree.MerkleTree, event *contracts.IssuerTransfer, blockNumber int64) error {
